    ...
    >
        <nav class="container mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="https://wa.me/6281264915088" target="_blank" class="hidden md:inline-flex px-5 py-2.5 bg-primary-500 text-white text-sm font-medium rounded-full shadow-lg shadow-primary-500/30 hover:bg-primary-600 hover:scale-105 transition-all transform">
                    Hubungi Kami
                </a>

                <a href="{{ route('login') }}" target="_blank" class="hidden md:inline-flex mt-3 px-5 py-2.5 bg-primary-500 text-white text-sm font-medium rounded-full shadow-lg shadow-primary-500/30 hover:bg-primary-600 hover:scale-105 transition-all transform">
                    Login
                </a>
        ...
        >
            <div class="flex flex-col p-4 space-y-2">
                ...
                @endforeach
                <a href="https://wa.me/6281264915088" target="_blank" class="block mt-4 text-center px-4 py-2 bg-primary-500 text-white rounded-lg font-semibold">
                    Hubungi Kami
                </a>
                <a href="{{ route('login') }}" target="_blank" class="block mt-2 text-center px-4 py-2 bg-primary-800 text-white rounded-lg font-semibold">
                    Login
                </a>
            </div>
        </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm text-gray-400 dark:text-gray-400">
                        <li class="flex items-start gap-3">
                            ...
                            <span>Komp Citra Graha Permai<br>Jl. Rawa Indah, Sidomulyo Timur, Marpoyan Damai, Pekanbaru - RIAU<br>Indonesia</span>
                        </li>
