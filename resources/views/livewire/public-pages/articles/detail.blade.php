<div class="bg-white dark:bg-gray-900 min-h-screen pb-20 pt-5 transition-colors duration-300">
    ...
    <div class="container mx-auto px-6 max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div class="lg:col-span-8 prose prose-green dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
            {!! $article->content !!}
            
            <div class="border-t border-b border-gray-100 dark:border-gray-800 py-6 mt-12 flex items-center justify-between not-prose">
                <span class="font-bold text-gray-900 dark:text-white">Bagikan artikel ini:</span>
                <div class="flex gap-2">
                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->fullUrl()) }}" target="_blank" class="w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center hover:bg-blue-700 transition shadow-lg shadow-blue-500/20">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.791-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                    <a href="https://wa.me/?text={{ urlencode($article->title . ' - ' . request()->fullUrl()) }}" target="_blank" class="w-10 h-10 rounded-full bg-green-500 text-white flex items-center justify-center hover:bg-green-600 transition shadow-lg shadow-green-500/20">
        ...
        <div class="lg:col-span-4 space-y-8">
            ...
            <div>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <a href="{{ route('articles.detail', $item->slug) }}" class="group flex gap-4 items-start">
                        ...
                        <div>
                            <h4 class="font-bold text-gray-800 dark:text-gray-200 text-sm leading-snug group-hover:text-primary-600 dark:group-hover:text-primary-400 transition mb-1 line-clamp-2">
                                {{ $item->title }}
                            </h4>
                            <span class="text-xs text-gray-400 dark:text-gray-500">{{ $item->formatted_date }}</span>
                        </div>
                    </a>
                    @endforeach
                </div>
